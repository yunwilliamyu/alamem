...
Some portion of the code was generated by Gemini, and Gemini assisted substantially in optimization. For example, basically all of the boilerplate and all of the bit-fiddling functions were Gemini-written. Also, the helper analysis software in `src/bin` were all basically vibe-coded. 
